...
export const Color = () => {
    return (
        <div className="bg-gradient-to-r from-[#9078C0] via-purple-400 to-[#FAE6FA] flex justify-center px-4 sm:px-6 md:px-10">
                        ...
                        <div className="mt-8">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8">
                                ...
                                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                    ...
                                    <button className="bg-[#512888] text-white px-4 py-2 rounded-2xl text-sm sm:text-base">
                                        Scan content
                                    </button>
                                </div>
                            </div>
